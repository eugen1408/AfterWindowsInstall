...
IF ($RU)
{
	...
	Write-Host "Папки Документы и Загрузки будут помещены на рабочий стол."
...
else
{
	...
	Write-Host "folder will be created. Documents and Downloads folders will be moved to Desktop folder."
...
# Documents
# Документы
$DocumentsFolder = "${DesktopReg}\Documents"
...
# Downloads
# Загрузки
$DownloadsFolder = "${DesktopReg}\Downloads"
...
# Показывать чекбоксы для выделения объектов
New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name AutoCheckSelect -Value 1 -Force
...
# Set the Control Panel view by Small icons
# Установить мелкие значки в панели управления
IF (-not (Test-Path -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ControlPanel))
{
	New-Item -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ControlPanel -Force
}
New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ControlPanel -Name AllItemsIconView -Value 1 -Force
...
# Скорость повтора при печати
New-ItemProperty -Path "Registry::HKEY_USERS\.DEFAULT\Control Panel\Keyboard" -Name KeyboardDelay -PropertyType String -Value 0 -Force
New-ItemProperty -Path "Registry::HKEY_USERS\.DEFAULT\Control Panel\Keyboard" -Name KeyboardSpeed -PropertyType String -Value 31 -Force
...
# Ctrl+Shift layout switch
New-ItemProperty -Path "Registry::HKEY_USERS\.DEFAULT\Keyboard Layout\Toggle" -Name Hotkey -PropertyType String -Value 2 -Force
New-ItemProperty -Path "Registry::HKEY_USERS\.DEFAULT\Keyboard Layout\Toggle" -Name "Language Hotkey" -PropertyType String -Value 2 -Force
New-ItemProperty -Path "Registry::HKEY_USERS\.DEFAULT\Keyboard Layout\Toggle" -Name Hotkey -PropertyType String -Value 1 -Force
New-ItemProperty -Path "HKCU:\Keyboard Layout\Toggle" -Name "Layout Hotkey" -PropertyType String -Value 2 -Force
New-ItemProperty -Path "HKCU:\Keyboard Layout\Toggle" -Name "Language Hotkey" -PropertyType String -Value 2 -Force
New-ItemProperty -Path "HKCU:\Keyboard Layout\Toggle" -Name "Layout Hotkey" -PropertyType String -Value 1 -Force
...
New-ItemProperty -Path "HKCU:\Keyboard Layout\Preload" -Name 1 -PropertyType String -Value 00000409 -Force
New-ItemProperty -Path "HKCU:\Keyboard Layout\Preload" -Name 2 -PropertyType String -Value 00000419 -Force
